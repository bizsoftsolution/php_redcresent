...
if(isset($_REQUEST['name']))
{
	...
	$sql = "INSERT INTO tbl_registration_form (full_name, ic_passport_no, age, sex, nationality, race, dob, contact_number, email_id, billing_address, post_code, city, state, country, payment_method, school_name, t_shirt_adult, t_shirt_kids, emergency_contact_name, emergency_contact_no, emergency_contact_relationship, parent_name, parent_ic_no) VALUES ('".$_REQUEST['name']."', '".$_REQUEST['name1']."', '".$_REQUEST['name2']."', '".$_REQUEST['name3']."', '".$_REQUEST['name4']."', '".$_REQUEST['name5']."', '".$_REQUEST['name6']."', '".$_REQUEST['name7']."', '".$_REQUEST['name8']."', '".$_REQUEST['name9']."', '".$_REQUEST['name10']."', '".$_REQUEST['name11']."', '".$_REQUEST['name12']."', '".$_REQUEST['name13']."', '".$_REQUEST['name14']."', '".$_REQUEST['name15']."', '".$_REQUEST['name16']."', '".$_REQUEST['name17']."', '".$_REQUEST['name18']."', '".$_REQUEST['name19']."', '".$_REQUEST['name20']."', '".$_REQUEST['name21']."', '".$_REQUEST['name22']."');";
