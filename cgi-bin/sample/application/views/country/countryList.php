        ...
        <div class="panel-heading">
         ...
         <table class="table datatable-button-print-columns">
            ...
            ?>
              ...
              </a>&nbsp;&nbsp;<a href="<?php echo base_url(); ?>country/deleteCountry/<?php echo $row->country_id;?>"  title="Delete" class="btn bg-danger remove" onclick="return confirm('Are You Sure to delete');"><i class="glyphicon glyphicon-remove "></i></a>
              </td>
              </tr>
              <?php $i++;}?>
