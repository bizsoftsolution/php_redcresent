         ...
         <div class="category-content no-padding">
            <ul class="navigation navigation-main navigation-accordion">
               ...
               <?php //if($this->session->userdata('user_type')=='SUPERADMIN')
                  //  {
                  ?>
               <li ><a href="<?php echo base_url('Image/allgallery');?>"><i class="icon-people"></i> <span>Gallery</span></a></li>
               <li ><a href="<?php echo base_url('Image/allslider');?>"><i class="icon-stack2"></i> <span>Slider</span></a></li>
			    <li ><a href="<?php echo base_url('Image/addQuatation');?>"><i class="icon-book"></i> <span>Add Quatation</span></a></li>
               <!--li>
                  <a href="#" class="has-ul legitRipple"><i class="icon-stack2"></i> <span>Master </span></a>
                  <ul class="hidden-ul">
                     <li><a href="<?php echo base_url('hroom/list1');?>" class="legitRipple">Room Details</a></li>
