        ...
        <section class="pad100">
            <div class="container">
                <div class="row">
					...
					<h3 style="color:#598084;"> Red Crescent Medias</h3><br>
                        <div class="text-center">
                            <img src="<?php echo base_url('assets/front-end/images/read/media.png')?>" alt="" class="img-responsive">
                        </div>
                    </div>
				...
				<div class="row">
					<div class="col-md-8 col-sm-8">
                        <div class="text-section-left">
                            <div class="text-section-title">
                                <h3>MRC(Chapter Klang) <span></span></h3>
                            </div>
                            <p style="text-align:justify;">
          MRCS Charity Bazaar to generate Fund for Victims of Haiyan Typhoon & Malaysian Floods.<br><br>
		  MRCS welcome all to attend and contribute in the name of Charity Bazaar.<br><br>
		  23 FEB 2014 (SUNDAY) <br>
10.00 am -06.00pm<br><br>
LAMAN LANAI, JALAN TUNKU ABDUL RAHMAN (next to Coliseum) KUALA LUMPUR <br>
For further info and coupon purchase please contact: <br><br>
Puan Nor Aziah Budin <br>
HP : 016 256 2164
