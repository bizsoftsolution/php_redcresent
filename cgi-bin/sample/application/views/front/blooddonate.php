        ...
        <section class="pad100">
            <div class="container">
                <div class="row">
					...
					<h3 style="color:#598084;"> Red Crescent Blood Donation</h3><br>
                        <div class="text-center">
                            <img src="<?php echo base_url('assets/front-end/images/services/blooddonate.png')?>" alt="" class="img-responsive">
                        </div>
                    </div>
				...
				<div class="row">
					<div class="col-md-8 col-sm-8">
                        <div class="text-section-left">
                            <div class="text-section-title">
                                <h3>Blood Donation <span>Drive</span></h3>
                            </div>
                            <p style="text-align:justify;">
            Blood donation is yet another act of selflessness favoured by those who wish to do something more or different; they may not have the resources to make monetary contributions or may not have the time or skill to engage in our voluntary programmes.<br><BR>
			It has long been a ‘tradition' of the Movement to provide free blood to those in need and the Malaysian Red Crescent(Chapter Klang) steadfastly upholds this cornerstone activity. Whilst the National Blood Bank (NBB) is the primary body for blood distribution, we strive to be the primary organisation to recruit, register and service blood donors. We work with NBB not only to ensure continuous and coordinated supply of blood but also to ensure that it is safe.<br><BR>
			MRC(Chapter Klang)would be delighted to support your organisation in organising blood drives. This includes coordinating with NBB and the Ministry of Health to arrange for personnel and transportation for collection and delivery to NBB.<br><BR>
			For more information and assistance, please <a style="color:red;" href="<?php echo base_url();?>/Front/contact">contact us</a> & visit our 
			<a  style="color:red;" href="<?php echo base_url();?>/Front/gallery">Image Gallery.
