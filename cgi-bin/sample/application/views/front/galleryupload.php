      ...
      <div class="panel panel-flat">
         <div class="panel-heading">
            ...
            <div style="text-align:right;">
               <a class="btn bg-violet" href="<?php echo  base_url();?>Image/addNew"><i class="glyphicon glyphicon-plus"></i> Add </a>
         ...
         <div class="container-fluid">
            ...
            <div class="col-md-8">
               ...
               <?php } ?>-->
               <?php foreach($galleryupdate as $row){?>
               <form name="add"   method="POST" action="<?php echo  base_url();?>Image/edit/<?php echo $row->id;?>" class="form-horizontal">
                  <div class="form-body">
                     <div class="form-group">
                        <label class="control-label col-md-3">Category</label>
                        <div class="col-md-9">
                           <input name="Category_name" class="form-control" type="text" value="<?php echo $row->categery;?>">
				 ...
				 <hr style="width:100%;">
				 <form name="add"   method="POST" action="<?php echo  base_url();?>Image/edit/<?php echo $row->id;?>" class="form-horizontal" enctype="multipart/form-data">
				 ...
				 <div class="row">
						...
						?>
						<div class="col-md-3">
							<img src="<?php echo base_url(); ?>upload/images/<?php echo $val_row; ?>" class="img-responsive">
						</div>
				 ...
				 <br><br><br>
                  ...
                  <div style="text-align:center">
                     <input type="submit" name="update_category_gallery" value="Update" class="btn btn-success">
                     <input type="reset" value="Reset" class="btn btn-danger">
                  </div>
               </form>
               <?php } ?>
