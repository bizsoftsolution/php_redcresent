        ...
        <section class="pad100">
            <div class="container">
                <div class="row">
					...
					<h3 style="color:#598084;"> Malaysian Red Crescent(Chapter Klang)Strategy2020</h3><br>
                        <div class="text-center">
                            <img src="<?php echo base_url('assets/front-end/images/services/strategy.png')?>" alt="" class="img-responsive">
                        </div>
                    </div>
				...
				<div class="row">
					<div class="col-md-8 col-sm-8">
                        <div class="text-section-left">
                            <div class="text-section-title">
                                <h3>Strategy <span>2020</span></h3>
                            </div>
                         <p style="text-align:justify;">
						 In moving forward to do more and better, we recognise the need to work differently in order to adapt to the challenges and opportunities presented by a fast changing world.<br><br>
						 Strategy 2020 is designed to ultimately benefit all who look to us to help build a more humane, dignified and peaceful world.<br><br>
						 Our three strategic aims:<br><br>
						 1)Save lives, protect livelihoods, and strengthen recovery from disasters and crises<br>
2)Enable healthy and safe living<br>
