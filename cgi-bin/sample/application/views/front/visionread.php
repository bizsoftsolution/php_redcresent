        ...
        <section class="pad100">
            <div class="container">
                <div class="row">
					...
					<h3 style="color:#598084;">Red Crescent Vision & Mission</h3><br>
                        <div class="text-center">
						
                            <img src="<?php echo base_url('assets/front-end/images/read/vision.png')?>" alt="" class="img-responsive">
                        </div>
                    </div>
           ...
           Human dignity and peace throughout the world 
						  ...
						  <div class="text-section-left">
							...
							<p style="text-align:justify;">
          Prevent and alleviate human suffering through humanitarian activities and actions  
