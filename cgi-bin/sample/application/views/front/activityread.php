        ...
        <section class="pad100">
            <div class="container">
                <div class="row">
					...
					<h3 style="color:#598084;"> Malaysia Red Crescent(Chapter Klang) Volunteers</h3><br>
                        <div class="text-center">
                            <img src="<?php echo base_url('assets/front-end/images/read/activities.png')?>" alt="" class="img-responsive">
                        </div>
                    </div>
				...
				<div class="row">
					<div class="col-md-8 col-sm-8">
                        <div class="text-section-left">
                            <div class="text-section-title">
                                <h3>Volunteering<span></span></h3>
                            </div>
                            <p style="text-align:justify;">
           Volunteering is the act of extending assistance or service in an altruistic manner without any financial gain. It is usually for the purpose of a common cause - to promote good or improve the quality of life. In return, this activity is acknowledged to produce a feeling of self-worth, respect and personal satisfaction.<br><br>
		   Volunteerism is well renowned for skill development, socialisation, and fun. It can serve to make contacts for possible employment and while some may take it on in order to build an impressive resume many do so because it is simply fulfilling.<br><br>
		   Many volunteers are specifically trained in the areas they work, such as medicine, education, or emergency rescue. Others serve on an as-needed basis, such as in response to a natural disaster.<br><br>
		   The Malaysian Red Crescent(Chapter Klang)encourages volunteering and has created many channels through which you can contribute your services. We recommend that you join as a member.<br><br>
		   All you have to do is contact our National HQ in Kuala Lumpur or MRC(Chapter Klang) for a membership form. As a member-volunteer you will be given a MRC identity card and may join our many courses and activities.<br><br>
		   
		    <strong> CONTACT FOR MEMBERSHIP:</strong><br>
			 <strong> Malaysian Red Crescent(Chapter Klang),</strong><br> 
			 <strong> No.7A,Jalan Tengku diauddin</strong><br>
			  <strong> 41000, Klang,Selangor Darulehsan.</strong><br>
			   <strong>TEL:603-33727454. </strong>
							</p>
                           <!--  <ul class="fa-ul">
                                <li><i class="fa-li fa fa-check-circle"></i>Interdum et malesuada fames ac ante</li>
                                <li><i class="fa-li fa fa-check-circle"></i>Malesuada fames ac ante ipsum</li>
