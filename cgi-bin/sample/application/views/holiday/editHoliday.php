      ...
      <div class="panel panel-flat">
         ...
         <div class="container-fluid">
            ...
            <div class="col-md-8">
               ...
               <form name="add"   method="POST" action="<?php echo  base_url();?>holiday/editHoliday/<?php echo $row->id;?>" class="form-horizontal">
                  <div class="form-body">
                     <div class="form-group">
                        <label class="control-label col-md-4">Date</label>
                        <div class="col-md-8">
                           <input name="date" placeholder="Auditorium" class="form-control" type="date" value="<?php echo $row->date1;?>">
				    ...
				    <div class="form-group">
                        ...
                        <div class="col-md-8">
                           <input name="details" placeholder="Room Nam" class="form-control" type="text" value="<?php echo $row->details;?>">
                           <span class="help-block"></span>
                        </div>
                     </div>
